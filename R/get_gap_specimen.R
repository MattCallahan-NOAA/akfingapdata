...
#' get_gap_taxonomics() is a related functions to look up species codes and area ids if necessary.
...
get_gap_specimen<-function(survey_definition_id=98, area_id=3, species_code=21740, start_year=1990, end_year=3000) {
